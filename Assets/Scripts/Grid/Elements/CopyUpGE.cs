...
[CreateAssetMenu(menuName = "GridElement/CopyUpGE")]
public class CopyUpGE : GridElement
{
    public override void Run(HexBoardTile tile)
    {
        ...
        HexBoardTile[] axialRunTiles = new HexBoardTile[2] { pivot.adjTiles[(int)Hexinal.SE], pivot.adjTiles[(int)Hexinal.NE] };
        ...
        while (true)
        {
            ...
            if (axialRunTiles[0] != null) axialRunTiles[0] = axialRunTiles[0].adjTiles[(int)Hexinal.SE];
            if (axialRunTiles[1] != null) axialRunTiles[1] = axialRunTiles[1].adjTiles[(int)Hexinal.NE];
